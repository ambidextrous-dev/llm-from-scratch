# Tests different tokenizers - SimpleV1, SimpleV2 and BPE and how we progressed to them based on their limitations
import tiktoken

from src.service.build_vocabulary import BuildVocabulary
from src.tokenizer.simple_tokenizer import SimpleTokenizerV1, SimpleTokenizerV2
